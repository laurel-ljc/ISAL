...
class AffordanceEnv(AMEEnv):
    ...
    def _after_termination_check(self):
        super()._after_termination_check()
        ...
        # Course success is a terminal RL episode, not a failed foot contact.
        self.collector.update_course(height, self._actor_map_root(), yaw, feet, forces, speed,
                                     torch.stack(support, -1), self.course_result)
